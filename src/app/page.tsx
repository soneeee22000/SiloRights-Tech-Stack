          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-400">
                6-layer microservices architecture for EU AI Act compliance
              </p>
            </div>
          </div>
          <p className="text-slate-400 max-w-3xl">
            SILOETT Rights is built as a 6-layer microservices architecture,
            designed for EU sovereignty, horizontal scalability, and EU AI Act
            compliance from day one.
          </p>

          {/* MVP Status Banner */}
          <div className="mt-6 inline-flex items-center gap-3 px-4 py-2 rounded-xl bg-emerald-500/10 border border-emerald-500/20">
            ...
            <span className="text-xs text-slate-500">
              — Full UI with role-based dashboards
            </span>
          </div>
        </div>
